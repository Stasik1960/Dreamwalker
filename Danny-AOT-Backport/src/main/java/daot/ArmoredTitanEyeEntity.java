...
public class ArmoredTitanEyeEntity extends MobEntity {
   private static final TrackedData<Optional<UUID>> DATA_PARENT_UUID = DataTracker.registerData(
      ArmoredTitanEyeEntity.class, TrackedDataHandlerRegistry.OPTIONAL_UUID
   );
   ...
   private static final Map<Integer, ArmoredTitanEyeEntity> clientInstances = new ConcurrentHashMap<>();
   ...
   public static ArmoredTitanEyeEntity getClientInstance(int parentEntityId) {
   ...
   public ArmoredTitanEyeEntity(EntityType<? extends MobEntity> entityType, World level) {
      ...
      if (this.getWorld().isClient()) {
         ...
         if (attacker instanceof LivingEntity livingAttacker) {
            ...
            if (parent != null && !parent.isBlinded()) {
               ...
               if (livingAttacker instanceof PlayerEntity player) {
                  player.sendMessage(Text.literal("Critical hit! Armored Titan blinded for 6 seconds!"), true);
               }
