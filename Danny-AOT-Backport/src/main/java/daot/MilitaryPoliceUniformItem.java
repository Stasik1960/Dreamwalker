...
public class MilitaryPoliceUniformItem extends daot.compat.BackportArmorItem implements GeoItem {
   ...
   public MilitaryPoliceUniformItem(ArmorMaterial material, Type type, Settings properties) {
