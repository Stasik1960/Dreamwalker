...
public class UniformItem extends daot.compat.BackportArmorItem implements GeoItem {
   ...
   public UniformItem(ArmorMaterial material, Type type, Settings properties) {
