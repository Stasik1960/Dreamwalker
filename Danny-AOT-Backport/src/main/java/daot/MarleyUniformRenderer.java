...
public class MarleyUniformRenderer extends GeoArmorRenderer<MarleyUniformItem> {
   public MarleyUniformRenderer() {
      super(new MarleyUniformModel());
   }
