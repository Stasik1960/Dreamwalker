...
public class MarleyEldianUniformItem extends daot.compat.BackportArmorItem implements GeoItem {
   ...
   public MarleyEldianUniformItem(ArmorMaterial material, Type type, Settings properties) {
