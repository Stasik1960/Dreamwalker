...
public class TitanBeardRenderer extends GeoEntityRenderer<TitanBeardEntity> {
   ...
   public TitanBeardRenderer(Context context) {
      super(context, new TitanBeardModel());
   }

   public void render(TitanBeardEntity entity, float entityYaw, float partialTick, MatrixStack poseStack, VertexConsumerProvider bufferSource, int packedLight) {
      super.render(entity, entityYaw, partialTick, poseStack, bufferSource, packedLight);
      this.syncHitboxBones(entity, partialTick);
   }

   private void syncHitboxBones(TitanBeardEntity entity, float partialTick) {
            ...
            if (!(distSq > 4096.0)) {
               ...
               if (napeBone == null && eyeBone == null) {
                  if (!loggedMissing.containsKey(entity.getId())) {
                     ...
                     System.out.println("[TitanBeardHitboxSync] WARNING: nape_hitbox and eye_hitbox bones not found in model!");
                  }
               } else {
   ...
   protected float getDeathMaxRotation(TitanBeardEntity animatable) {
      return 0.0F;
   }

   public int getPackedOverlay(TitanBeardEntity animatable, float u, float partialTick) {
