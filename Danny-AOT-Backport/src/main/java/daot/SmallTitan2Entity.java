...
public class SmallTitan2Entity extends HostileEntity implements GeoEntity, EyeHurtTitan, GrabbingTitan, daot.compat.BaseDimensionsProvider {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   private static final TrackedData<Boolean> DATA_IS_AGGRESSIVE = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_SITTING = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_LUNGING = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_EATING = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_EAT_TICK = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Boolean> DATA_IS_EATING_LUNGE = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_EYE_HURT = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_DEAD = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_RUN_ANIMATION = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Boolean> DATA_IS_CLIMBING = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_EATING_TARGET_ID = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Boolean> DATA_DISMOUNT_ALLOWED = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_COMMANDED_STOP = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_TEXTURE_VARIANT = DataTracker.registerData(SmallTitan2Entity.class, TrackedDataHandlerRegistry.INTEGER);
   ...
   private SmallTitan2NapeEntity napeEntity = null;
   private SmallTitan2EyeEntity eyeEntity = null;
   ...
   private static double getWanderSpeed() {
      return ModConfig.get().smallTitan2WanderSpeed;
   }

   private static double getChaseSpeed() {
      return ModConfig.get().smallTitan2ChaseSpeed;
   }
   ...
   public SmallTitan2NapeEntity getNapeEntity() {
      return this.napeEntity;
   }

   public SmallTitan2EyeEntity getEyeEntity() {
      return this.eyeEntity;
   }

   public SmallTitan2Entity(EntityType<? extends HostileEntity> entityType, World level) {
   ...
   public EntityDimensions getBaseDimensions(EntityPose pose) {
      return this.isEyeHurt() ? EntityDimensions.changing(1.8F, 8.0F) : EntityDimensions.changing(1.8F, 6.0F);
   }

   public static boolean checkSmallTitan2SpawnRules(
      EntityType<SmallTitan2Entity> entityType, ServerWorldAccess level, SpawnReason spawnType, BlockPos pos, Random random
   ) {
   ...
   public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData, net.minecraft.nbt.NbtCompound entityNbt) {
      ...
      if (!this.getWorld().isClient()) {
         SmallTitan2NapeEntity nape = new SmallTitan2NapeEntity(DannysAot.SMALL_TITAN_2_NAPE, this.getWorld());
         nape.setParentTitan(this);
         nape.setPosition(this.getX(), this.getY(), this.getZ());
         this.getWorld().spawnEntity(nape);
         this.napeEntity = nape;
         SmallTitan2EyeEntity eye = new SmallTitan2EyeEntity(DannysAot.SMALL_TITAN_2_EYE, this.getWorld());
         ...
         this.setTextureVariant(this.random.nextInt(4));
   ...
   protected void initGoals() {
      this.goalSelector.add(1, new SmallTitan2Entity.SmallTitan2LungeGoal(this));
      this.goalSelector.add(2, new SmallTitan2Entity.SmallTitan2ChaseGoal(this));
      this.goalSelector.add(3, new SmallTitan2Entity.SmallTitan2SitGoal(this));
      this.goalSelector.add(4, new SmallTitan2Entity.SmallTitan2WanderGoal(this));
      this.goalSelector.add(5, new TitanLookAtPlayerGoal(this, 40.0));
      this.goalSelector.add(6, new LookAroundGoal(this));
      this.targetSelector.add(1, new RevengeGoal(this));
      this.targetSelector.add(2, new SmallTitan2Entity.SmallTitan2FindTargetGoal(this));
   }
   ...
   public void tick() {
      ...
      if (!this.getWorld().isClient() && this.horizontalCollision && !this.isOnGround() && !this.isCommandedStop()) {
         ...
         boolean ownerCommanded = climbOwner != null && VillagerTransformTracker.hasActiveTarget(climbOwner);
         if (ownerCommanded || BloodmoonState.isActive()) {
   ...
   static class SmallTitan2ChaseGoal extends Goal {
      private final SmallTitan2Entity titan;
      private int repathTimer = 0;
      private Path path = null;

      public SmallTitan2ChaseGoal(SmallTitan2Entity titan) {
         this.titan = titan;
   ...
   static class SmallTitan2FindTargetGoal extends Goal {
      private final SmallTitan2Entity titan;
      private int searchCooldown = 0;
      private int retargetCooldown = 0;

      public SmallTitan2FindTargetGoal(SmallTitan2Entity titan) {
         this.titan = titan;
   ...
   static class SmallTitan2LungeGoal extends Goal {
      private final SmallTitan2Entity titan;

      public SmallTitan2LungeGoal(SmallTitan2Entity titan) {
         this.titan = titan;
         this.setControls(EnumSet.of(Control.MOVE));
      }
   ...
   static class SmallTitan2SitGoal extends Goal {
      private final SmallTitan2Entity titan;
      private int sitDuration = 0;
      private int sitTimer = 0;

      public SmallTitan2SitGoal(SmallTitan2Entity titan) {
         this.titan = titan;
         this.setControls(EnumSet.of(Control.MOVE));
      }
   ...
   static class SmallTitan2WanderGoal extends Goal {
      private final SmallTitan2Entity titan;
      ...
      public SmallTitan2WanderGoal(SmallTitan2Entity titan) {
         this.titan = titan;
         this.setControls(EnumSet.of(Control.MOVE));
      }
         ...
         if (this.wanderTarget != null) {
            ...
            if (this.wanderTicks < 100) {
               ...
               if (horizontalDistSqr > 1.0E-4) {
                  ...
                  this.titan.targetYRot = desiredYaw;
                  double horizontalDist = Math.sqrt(horizontalDistSqr);
                  double speed = SmallTitan2Entity.getWanderSpeed() * this.titan.speedMultiplier;
                  Vec3d movement = new Vec3d(dx / horizontalDist * speed, this.titan.getVelocity().y, dz / horizontalDist * speed);
                  this.titan.setVelocity(movement);
               }
            }
