...
public class MilitaryPoliceUniformRenderer extends GeoArmorRenderer<MilitaryPoliceUniformItem> {
   public MilitaryPoliceUniformRenderer() {
      super(new MilitaryPoliceUniformModel());
   }

   public void updateModelState(LivingEntity entity, ItemStack stack) {
      ((MilitaryPoliceUniformModel)this.getGeoModel()).currentUseTitan = UniformSkin.useTitan(entity, stack);
   }
   ...
   public void preRender(
      ...
      MilitaryPoliceUniformItem animatable,
      BakedGeoModel model,
