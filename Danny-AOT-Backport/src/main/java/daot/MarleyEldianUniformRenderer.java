...
public class MarleyEldianUniformRenderer extends GeoArmorRenderer<MarleyEldianUniformItem> {
   public MarleyEldianUniformRenderer() {
      super(new MarleyEldianUniformModel());
   }
   ...
   public void preRender(
      ...
      MarleyEldianUniformItem animatable,
      BakedGeoModel model,
