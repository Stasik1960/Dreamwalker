...
public class ScoutUniformRenderer extends GeoArmorRenderer<ScoutUniformItem> {
   public ScoutUniformRenderer() {
      super(new ScoutUniformModel());
   }

   public void updateModelState(LivingEntity entity, ItemStack stack) {
      ((ScoutUniformModel)this.getGeoModel()).currentUseTitan = UniformSkin.useTitan(entity, stack);
   }
