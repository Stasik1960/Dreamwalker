...
public class MarleyUniformItem extends daot.compat.BackportArmorItem implements GeoItem {
   ...
   public MarleyUniformItem(ArmorMaterial material, Type type, Settings properties) {
