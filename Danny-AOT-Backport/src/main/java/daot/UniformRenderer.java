...
public class UniformRenderer extends GeoArmorRenderer<UniformItem> {
   public UniformRenderer() {
      super(new UniformModel());
   }

   public void updateModelState(LivingEntity entity, ItemStack stack) {
      ((UniformModel)this.getGeoModel()).currentUseTitan = UniformSkin.useTitan(entity, stack);
   }
