...
public class ThunderSpearItemRenderer extends GeoItemRenderer<ThunderSpearItem> {
   private static final Identifier SPRITE = new Identifier("dannys-aot", "textures/item/thunder_spear_sprite.png");

   public ThunderSpearItemRenderer() {
      super(new ThunderSpearItemModel());
   }
