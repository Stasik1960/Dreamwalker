...
public class AttackTitanGrabEntity extends MobEntity {
   private static final TrackedData<Optional<UUID>> DATA_PARENT_UUID = DataTracker.registerData(
      AttackTitanGrabEntity.class, TrackedDataHandlerRegistry.OPTIONAL_UUID
   );
   ...
   private static final Map<Integer, AttackTitanGrabEntity> clientInstances = new ConcurrentHashMap<>();
   ...
   public static AttackTitanGrabEntity getClientInstance(int parentEntityId) {
   ...
   public AttackTitanGrabEntity(EntityType<? extends MobEntity> entityType, World level) {
