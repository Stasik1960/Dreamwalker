...
public class BasementKeyItem extends daot.compat.BackportArmorItem implements GeoItem {
   ...
   public BasementKeyItem(ArmorMaterial material, Type type, Settings properties) {
      super(material, type, properties);
   }

   @Override
   public Text getName(ItemStack stack) {
      return Text.literal("Basement Key").formatted(Formatting.BOLD, Formatting.GOLD);
   }
   ...
   public void registerControllers(ControllerRegistrar controllers) {
      controllers.add(new AnimationController(this, "key_necklace_controller", 0, state -> PlayState.STOP));
   }
