...
public class ScoutUniformItem extends daot.compat.BackportArmorItem implements GeoItem {
   ...
   public ScoutUniformItem(ArmorMaterial material, Type type, Settings properties) {
