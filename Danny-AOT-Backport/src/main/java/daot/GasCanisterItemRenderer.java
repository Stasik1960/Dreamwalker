...
public class GasCanisterItemRenderer extends GeoItemRenderer<GasCanisterItem> {
   private static final Identifier SPRITE = new Identifier("dannys-aot", "textures/item/gas_canister_item.png");

   public GasCanisterItemRenderer() {
      super(new GasCanisterItemModel());
   }
