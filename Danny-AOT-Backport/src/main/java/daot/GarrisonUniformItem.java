...
public class GarrisonUniformItem extends daot.compat.BackportArmorItem implements GeoItem {
   ...
   public GarrisonUniformItem(ArmorMaterial material, Type type, Settings properties) {
