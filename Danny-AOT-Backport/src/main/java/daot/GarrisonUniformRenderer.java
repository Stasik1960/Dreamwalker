...
public class GarrisonUniformRenderer extends GeoArmorRenderer<GarrisonUniformItem> {
   public GarrisonUniformRenderer() {
      super(new GarrisonUniformModel());
   }

   public void updateModelState(LivingEntity entity, ItemStack stack) {
      ((GarrisonUniformModel)this.getGeoModel()).currentUseTitan = UniformSkin.useTitan(entity, stack);
   }
   ...
   public void preRender(
      ...
      GarrisonUniformItem animatable,
      BakedGeoModel model,
