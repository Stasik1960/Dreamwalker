...
public class ZekesGlassesItemRenderer extends GeoItemRenderer<ZekesGlassesItem> {
   private static final Identifier SPRITE = new Identifier("dannys-aot", "textures/item/zeke_glasses_item.png");

   public ZekesGlassesItemRenderer() {
      super(new ZekesGlassesItemModel());
   }
