...
public class AttackTitanEntity extends HostileEntity implements GeoEntity, ShifterTitan, WireRestrainable, daot.compat.BaseDimensionsProvider {
   public static final Set<String> VARIANT_SHIFTERS = Set.of("Speakor", "Kronart");
   public static BiConsumer<AnimationController<AttackTitanEntity>, AttackTitanEntity> MOVEMENT_KEYFRAME_INSTALLER = null;
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   private int idleTicks = 0;
   private static final int IDLE_BORED_THRESHOLD = 100;
   private static final TrackedData<Boolean> DATA_IS_MOVING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Optional<UUID>> DATA_SHIFTER_UUID = DataTracker.registerData(
      AttackTitanEntity.class, TrackedDataHandlerRegistry.OPTIONAL_UUID
   );
   private static final TrackedData<Integer> DATA_TRANSFORMATION_TICKS = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Integer> DATA_WIRE_RESTRAINT = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Boolean> DATA_IS_DISMOUNTING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_LAST_STOMP_TICK = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Boolean> DATA_IS_SPRINTING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_ATTACKING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_ATTACK_NUMBER = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Boolean> DATA_IS_ARMED = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_WAS_MOVING_ON_ATTACK = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_LAST_ATTACK_IMPACT_TICK = DataTracker.registerData(
      AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER
   );
   private static final TrackedData<Boolean> DATA_IS_CROUCHING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_HIT_REACTION = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Boolean> DATA_LOW_STAMINA = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_LAST_HIT_TICK = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Boolean> DATA_SLIDING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Float> DATA_HIT_DIR_YAW = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.FLOAT);
   private static final TrackedData<Boolean> DATA_IS_IMPALED = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_FALLING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_LANDING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_LAST_LANDING_TICK = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Float> DATA_LANDING_INTENSITY = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.FLOAT);
   private static final TrackedData<Boolean> DATA_IS_JUMPING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_JUMP_LAUNCHED = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Float> DATA_JUMP_VEL_X = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.FLOAT);
   private static final TrackedData<Float> DATA_JUMP_VEL_Y = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.FLOAT);
   private static final TrackedData<Float> DATA_JUMP_VEL_Z = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.FLOAT);
   private static final TrackedData<Boolean> DATA_IS_DEFEATED = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_PROTECTING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_GRABBED_ENTITY_ID = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Integer> DATA_GRAB_PHASE = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Boolean> DATA_VARIANT_SHIFTER = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_FULLY_DISMOUNTED = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Integer> DATA_HARDENING_MODE = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.INTEGER);
   private static final TrackedData<Boolean> DATA_IS_CLIMBING = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_INCAPACITATED = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Boolean> DATA_IS_KNOCKED = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   private static final TrackedData<Float> DATA_KNOCKED_YAW = DataTracker.registerData(AttackTitanEntity.class, TrackedDataHandlerRegistry.FLOAT);
   ...
   private static final RawAnimation IDLE_BORED_ANIM = RawAnimation.begin().thenLoop("idle_bored");
   private static final RawAnimation IDLE_BORED_UPPER_ANIM = RawAnimation.begin().thenLoop("idle_bored_upper");
   private static final RawAnimation DISMOUNT_CROUCH_ANIM = RawAnimation.begin().thenLoop("dismount_crouch");
   ...
   private static final double[] VARIANT_WALK_STOMP_KEYFRAMES = new double[]{0.25, 1.25};
   ...
   private static final int JAB_TICKS = 10;
   private static final int VARIANT_JAB_TICKS = 20;
   ...
   private static final int VARIANT_JAB_EFFECT_TICK = 10;
   ...
   private static final EntityDimensions DISMOUNTED_DIMENSIONS = EntityDimensions.changing(3.0F, 7.5F);
   ...
   protected AttackTitanNapeEntity napeEntity = null;
   protected AttackTitanEyeEntity eyeEntity = null;
   protected AttackTitanGrabEntity grabHitboxEntity = null;
   ...
   protected ServerBossBar bossBar = null;
   ...
   private static final double[] VARIANT_RUN_STOMP_KEYFRAMES = new double[]{0.0};

   public boolean isVariantShifter() {
      return true;
   }
   ...
   protected boolean isAbilityAttackNumber(int attackNumber) {
      return attackNumber == 3 || attackNumber == 4;
   }
   ...
   private int jabTicks() {
      return this.isVariantShifter() ? 20 : 10;
   }

   private int jabEffectTick() {
      return this.isVariantShifter() ? 10 : 10;
   }

   public AttackTitanNapeEntity getNapeEntity() {
      return this.napeEntity;
   }

   public AttackTitanEyeEntity getEyeEntity() {
      return this.eyeEntity;
   }

   public AttackTitanGrabEntity getGrabHitboxEntity() {
   ...
   protected int getJumpLandingCooldown() {
      return 10;
   }

   protected void applyJumpLandingCooldown() {
      this.jumpCooldownTicks = this.getJumpLandingCooldown();
   }
   ...
   protected int getAttackEffectTick(int attackNum) {
      return attackNum == 1 ? 14 : 12;
   }

   protected int getAttackSwingStartTick(int attackNum) {
      return Math.max(1, this.getAttackEffectTick(attackNum) - 4);
   }

   protected boolean isJumpBlockedByAttack() {
      return this.isTitanAttacking() || this.attackCooldown > 0;
   }

   protected void forceStartJumpArc(double dirX, double dirZ) {
      this.jumpDirX = dirX;
      this.jumpDirZ = dirZ;
   ...
   public AttackTitanEntity(EntityType<? extends HostileEntity> entityType, World level) {
   ...
   public void spawnHitboxes() {
      if (!this.getWorld().isClient() && this.napeEntity == null && this.eyeEntity == null) {
         ...
         DannysAot.LOGGER.info("Spawned Attack Titan hitboxes");
      }
   }
   ...
   protected void initDataTracker() {
      ...
      this.dataTracker.startTracking(DATA_VARIANT_SHIFTER, false);
      this.dataTracker.startTracking(DATA_FULLY_DISMOUNTED, false);
   ...
   private void toggleHardening() {
      if (!this.getWorld().isClient()) {
         int mode = this.getHardeningMode();
         this.setHardeningMode(mode == 0 ? 1 : 0);
   ...
   public void onTrackedDataSet(TrackedData<?> data) {
      ...
      if (data == DATA_IS_DISMOUNTING || data == DATA_IS_CROUCHING || data == DATA_FULLY_DISMOUNTED) {
   ...
   protected boolean isJumpingForAnim() {
   ...
   protected boolean isFallingForAnim() {
   ...
   public EntityDimensions getBaseDimensions(EntityPose pose) {
      if (this.dataTracker.get(DATA_FULLY_DISMOUNTED)) {
         return DISMOUNTED_DIMENSIONS;
      } else {
         ...
         if (shifterUUID != null) {
            for (Entity passenger : this.getPassengerList()) {
               if (passenger instanceof ServerPlayerEntity serverPlayer && serverPlayer.getUuid().equals(shifterUUID)) {
                  ...
                  DannysAot.LOGGER.info("Attack Titan defeated with rider {} still attached", serverPlayer.getName().getString());
                  break;
               }
            }
         }
   ...
   public void updatePassengerPosition(Entity passenger, PositionUpdater positionUpdater) {
      if (this.hasPassenger(passenger)) {
         if (this.isDefeated()) {
            AttackTitanNapeEntity nape = this.getWorld().isClient() ? AttackTitanNapeEntity.getClientInstance(this.getId()) : this.napeEntity;
            if (nape != null) {
         ...
         double targetForwardOffset = this.isTitanClimbing() ? -3.0 : 1.0;
         double yOffset = 0.0;
         if (this.isVariantShifter() && this.isDismounting()) {
            targetForwardOffset++;
            yOffset--;
         }
         ...
         double y = this.getY() + ridePos.y + this.smoothYOffset + yOffset;
   ...
   protected float getSaddledSpeed(PlayerEntity controllingPlayer) {
      if (!this.isLanding() && !this.isDefeated() && !this.isKnocked() && !this.isThrowCharging() && !this.isThrowing() && !this.isEating()) {
         int attackNum = this.getAttackNumber();
         boolean isGroundsmash = this.isTitanAttacking() && attackNum == 3;
         boolean canRun = this.isSprinting() && !isGroundsmash && !this.isArmed() && !this.isInSneakingPose();
         double targetSpeed;
         ...
         if (this.isVariantShifter() && !canRun && !this.isInSneakingPose()) {
            this.currentSpeed /= 1.5;
         }

         this.currentSpeed = this.currentSpeed * StrwsRestraintTracker.movementFactor(this, this.getWireRestraintCount());
         return (float)this.currentSpeed;
      } else {
      ...
      if (passenger instanceof PlayerEntity player) {
         ...
         if (shifterUUID != null && player.getUuid().equals(shifterUUID)) {
            ...
            if (!this.getWorld().isClient()) {
               ...
               if (this.dataTracker.get(DATA_VARIANT_SHIFTER) && this.usesKneelDismount()) {
                  this.setDismounting(false);
                  this.dismountVisibilityDelay = 0;
                  this.allowDismount = false;
                  this.dataTracker.set(DATA_FULLY_DISMOUNTED, true);
   ...
   public void onPlayerShift(PlayerEntity player) {
      ...
      if (VARIANT_SHIFTERS.contains(player.getGameProfile().getName())) {
         this.dataTracker.set(DATA_VARIANT_SHIFTER, true);
      }
      ...
      if (!this.getWorld().isClient() && this.getWorld().getGameRules().getBoolean(DannysAot.RULE_SHIFT_BOSS_BARS)) {
         String bossBarName = player.getCommandTags().contains("titan_stealth") ? "Attack Titan" : "Attack Titan - " + player.getName().getString();
         this.bossBar = new ServerBossBar(Text.literal(bossBarName), Color.GREEN, Style.PROGRESS);
      ...
      if (!this.getWorld().isClient() && this.getWorld() instanceof ServerWorld serverLevel) {
         ...
         boolean lethalExplosion = this.shiftExplosionDamagesEntities();
         boolean griefing = lethalExplosion
            && DannysAot.isTitanGriefingEnabled(this.getWorld())
            && DannysAot.isShifterExplosionDamageEnabled(this.getWorld())
            && !stealthShift;
         if (!stealthShift && lethalExplosion) {
            if (griefing) {
         ...
         } else if (!stealthShift) {
            serverLevel.spawnParticles(ParticleTypes.EXPLOSION_EMITTER, centerX, centerY, centerZ, 1, 0.0, 0.0, 0.0, 0.0);
            serverLevel.spawnParticles(ParticleTypes.EXPLOSION_EMITTER, centerX, centerY + 8.0, centerZ, 1, 0.0, 0.0, 0.0, 0.0);
            serverLevel.playSound(null, centerX, centerY, centerZ, SoundEvents.ENTITY_GENERIC_EXPLODE, SoundCategory.HOSTILE, 4.0F, 0.6F);
         }
            ...
            if (entity != player
               ...
               if (distance > 0.0 && distance < maxRange) {
                  ...
                  if (entity instanceof LivingEntity living) {
                     ...
                     damage *= this.shiftExplosionDamageScale();
         ...
         if (this.isKnocked()) {
            ...
            if (this.attackCooldown <= 0 && !this.isTransforming() && !this.isDismounting()) {
               ...
               if (this.isArmed()) {
                  ...
                  nextAttack = this.lastAttackNumber >= this.comboAttackCount() ? 1 : this.lastAttackNumber + 1;
                  this.lastAttackNumber = nextAttack;
               }

               int attackTicks = nextAttack != 10 && nextAttack != 11 ? this.attackAnimTicks(nextAttack) : this.jabTicks();
      ...
      if (!this.isDefeated()) {
         if (this.isKnocked()) {
            ...
            if (abilityNumber == 6) {
               ...
               } else if (abilityNumber == 3 && this.protectActive) {
                  this.cancelProtect();
               } else {
                  if (this.protectActive) {
                     this.cancelProtect();
   ...
   public void releaseGrabbedEntity() {
      ...
      if (grabbedId != -1) {
         ...
         if (grabbed != null) {
            if (grabbed.getVehicle() instanceof AttackTitanGrabEntity grabHitbox) {
      ...
      if (this.getGrabPhase() == 4) {
         ...
         if (grabbed != null && grabbed.isAlive()) {
            if (this.eatTicks >= 24 && !this.eatDropDone) {
               ...
               if (grabbed.getVehicle() instanceof AttackTitanGrabEntity gh) {
   ...
   private void destroyBlocksAlongSwing(float swingProgress) {
      if (this.getWorld() instanceof ServerWorld serverLevel) {
         if (DannysAot.isTitanGriefingEnabled(this.getWorld())) {
            ...
            double rightX = forwardZ;
            double rightZ = -forwardX;
            double reachScale = this.getAttackReachScale();
            double sideOffset = (1.0 - swingProgress) * 5.0 * reachScale;
            double forwardDist = (3.0 + swingProgress * 7.0) * reachScale;
            double crouchOffset = this.isInSneakingPose() ? 5.0 : 0.0;
            double armHeight = (11.0 - crouchOffset - swingProgress * 4.0) * reachScale;
            int baseY = (int)Math.floor(this.getY() + armHeight);
            int handRadius = Math.max(1, (int)Math.round(2.0 * reachScale));
            int forearmRadius = Math.max(1, (int)Math.round(4.0 * reachScale));
               ...
               if (dot > 0.5 && toTarget.horizontalLength() < 10.0) {
                  if (target instanceof TitanNapeEntity napeEntity) {
                     ...
                     float kickDamage = isShifterTitan(target)
                        ? (float)(ModConfig.get().attackTitanKickDamage / 2.0)
                        : (float)ModConfig.get().attackTitanKickDamage;
                     kickDamage *= this.getAttackDamageMultiplier();
   ...
   protected void dealAttackDamage() {
      ...
      this.applyAttackDamage(null);
      this.drainAttackStamina();
   }

   protected void playAttackImpactSound() {
      ...
      double reach = this.getAttackReachScale();
      this.getWorld()
         .playSound(null, this.getX() + fx * 6.0 * reach, this.getY() + 3.0 * reach, this.getZ() + fz * 6.0 * reach, sound, SoundCategory.HOSTILE, 8.0F, pitch);
   }

   protected void applyAttackDamage(Set<UUID> alreadyHit) {
      float yawRad = (float)Math.toRadians(this.getYaw());
      double forwardX = -Math.sin(yawRad);
      double forwardZ = Math.cos(yawRad);
      double reachScale = this.getAttackReachScale();
      double hRange = ModConfig.get().attackTitanAttackRange * reachScale;
      double vInflate = 10.0 * reachScale;

      for (LivingEntity target : this.getWorld().getNonSpectatingEntities(LivingEntity.class, this.getBoundingBox().expand(hRange, vInflate, hRange))) {
         if ((alreadyHit == null || !alreadyHit.contains(target.getUuid())) && target != this && target.getVehicle() != this) {
            UUID shifterUUID = this.getShifterUUID();
            if ((shifterUUID == null || !target.getUuid().equals(shifterUUID))
               && !(target instanceof AttackTitanNapeEntity)
               && !(target instanceof AttackTitanEyeEntity)
               ...
               Vec3d toTarget = target.getPos().subtract(this.getPos());
               double dot = toTarget.normalize().dotProduct(new Vec3d(forwardX, 0.0, forwardZ));
               if (dot > 0.2 && toTarget.horizontalLength() < hRange) {
                  if (target instanceof TitanNapeEntity napeEntity) {
                     TitanEntity parentTitan = napeEntity.getParentTitan();
                     if (parentTitan != null) {
                        parentTitan.damage(this.getDamageSources().mobAttack(this), Float.MAX_VALUE);
                     ...
                     float attackDamage = isShifterTitan(target)
                        ? (
                           this.getAttackNumber() == 3
                              ? (float)(ModConfig.get().attackTitanAttackDamage * 2.0 / 3.0)
                              : (float)(ModConfig.get().attackTitanAttackDamage / 3.0)
                        )
                        : (float)ModConfig.get().attackTitanAttackDamage;
                     attackDamage *= this.getAttackDamageMultiplier();
                     if ((curAttackNum == 10 || curAttackNum == 11) && (isShifterTitan(target) || isPureTitan(target))) {
                        attackDamage *= 2.0F;
                     }

                     if (this.isArmsHardened() && (curAttackNum == 1 || curAttackNum == 2 || curAttackNum == 10 || curAttackNum == 11)) {
                        attackDamage *= 2.0F;
                     }
   ...
   protected void drainAttackStamina() {
      if (this.getFirstPassenger() instanceof ServerPlayerEntity sp) {
         ModNetworking.drainStamina(sp.getUuid(), this.isAbilityAttackNumber(this.getAttackNumber()) ? 15.0F : 5.0F);
      }
   }
      ...
      if (!this.getWorld().isClient() && !this.isDefeated()) {
         ...
         if (this.isDismounting()) {
            ...
            if (!(chargeFraction <= 0.0F)) {
               float perHitDamage = this.getMaxHealth() / Math.max(1, ModConfig.get().attackTitanNapeHits);
   ...
   public void triggerBlindness() {
      ...
      DannysAot.LOGGER.info("Attack Titan blinded for 6 seconds!");
      if (this.getControllingPassenger() instanceof PlayerEntity player) {
   ...
   public void tick() {
      if (!this.getWorld().isClient() && !this.configHealthApplied) {
         ...
         double configHealth = ModConfig.get().attackTitanHealth * this.getHealthMultiplier();
      ...
      if (!this.getWorld().isClient()) {
         boolean canClimbNow = this.isArmsHardened()
            && !this.isImpaled()
            && !this.isDismounting()
            && !this.isTransforming()
            && !this.isJumping()
         ...
         int mode = this.getHardeningMode();
         if (mode == 1 && canClimbNow) {
            this.setHardeningMode(2);
         } else if (mode == 2 && !canClimbNow) {
            this.setHardeningMode(1);
         }
      }
      ...
      if (this.jumpAnimTicks > 0) {
         ...
         if (ticksElapsed >= 4 && !this.jumpLaunched) {
            ...
            float hp = this.getJumpHorizontalPower();
            this.jumpVelX = this.jumpDirX * hp;
            this.jumpVelY = this.getJumpVerticalPower();
            this.jumpVelZ = this.jumpDirZ * hp;
            if (!this.getWorld().isClient()) {
      ...
      if (!this.getWorld().isClient()) {
         ...
         if (this.isTitanAttacking() && !this.attackEffectTriggered && this.getAttackNumber() != 5) {
            ...
            int effectTick = switch (attackNum) {
               case 1, 2 -> this.getAttackEffectTick(attackNum);
               case 3 -> 14;
               case 4 -> 18;
               default -> 10;
               case 10, 11 -> this.jabEffectTick();
            };
            if (attackNum == 1 || attackNum == 2) {
               int swingStart = this.getAttackSwingStartTick(attackNum);
               if (this.attackEffectTimer >= swingStart && effectTick > swingStart) {
                  float swingProgress = (float)(this.attackEffectTimer - swingStart) / (effectTick - swingStart);
      ...
      if (!this.getWorld().isClient() && this.isAlive() && !this.isDismounting()) {
         ...
         if (isActuallyMoving && this.stompCooldown <= 0 && !isFullBodyAttack) {
            ...
            if (walkingTicks >= 10L) {
               ...
               int simpleStompInterval = this.getSimpleStompIntervalTicks(isRunning);
               if (simpleStompInterval > 0) {
                  this.triggerStompEffects();
                  this.setLastStompTick(this.age);
                  this.stompCooldown = simpleStompInterval;
               } else {
                  double cadenceMul = this.isVariantShifter() && !isRunning ? 1.5 : 1.0;
                  boolean variantRun = this.isVariantShifter() && isRunning;
                  double ticksPerCycle = variantRun ? 6.0 : (isRunning ? 20.0 : 30.0) * cadenceMul;
                  double currentAnimTime = walkingTicks % ticksPerCycle / 20.0 / cadenceMul;
                  ...
                  if (keyframeIndex >= 0 && keyframeIndex != this.lastStompKeyframeIndex) {
                     ...
                     this.stompCooldown = variantRun ? 4 : (int)((isRunning ? 8 : 12) * cadenceMul);
                  }
   ...
   private int getStompKeyframeIndex(double animTime, boolean isRunning) {
      ...
      double[] keyframes;
      double cycleLength;
      if (isRunning && this.isVariantShifter()) {
         keyframes = VARIANT_RUN_STOMP_KEYFRAMES;
         cycleLength = 0.3;
         threshold = 0.08;
      } else if (isRunning) {
         keyframes = RUN_STOMP_KEYFRAMES;
         cycleLength = 1.0;
      } else if (this.isVariantShifter()) {
         keyframes = VARIANT_WALK_STOMP_KEYFRAMES;
         cycleLength = 2.0;
      } else {
   ...
   private void triggerStompEffects() {
      if (this.getWorld() instanceof ServerWorld serverLevel) {
         ...
         PlayerEntity exceptForFootstep = null;
         boolean keyframesCoverRider = this.usesKeyframeFootsteps() && !isRunningForSound;
         if (keyframesCoverRider && this.getControllingPassenger() instanceof PlayerEntity rider) {
            exceptForFootstep = rider;
         }

         this.getWorld()
            .playSound(exceptForFootstep, this.getX(), this.getY(), this.getZ(), ModSounds.TITAN_STOMP, SoundCategory.HOSTILE, stompVolume, randomPitch);
      }
   }
   ...
   public void registerControllers(ControllerRegistrar controllers) {
      AnimationController<AttackTitanEntity> movementController = new AnimationController(this, "movement_controller", 6, this::movementPredicate);
   ...
   private PlayState grabArmPredicate(AnimationState<AttackTitanEntity> state) {
      if (this.isTitanClimbing()) {
   ...
   private PlayState movementPredicate(AnimationState<AttackTitanEntity> state) {
      ...
      if (this.isDefeated()) {
         ...
         return PlayState.STOP;
      } else if (this.dataTracker.get(DATA_FULLY_DISMOUNTED)) {
         return PlayState.STOP;
         ...
         if (!this.isTitanAttacking() || attackNum != 3 && attackNum != 4 && attackNum != 5) {
            if (this.isThrowCharging() || this.isThrowing() || this.isEating()) {
               ...
               return this.isVariantShifter() && this.idleTicks >= 100 ? state.setAndContinue(IDLE_BORED_ANIM) : state.setAndContinue(IDLE_ANIM);
            }
         } else {
            return state.setAndContinue(IDLE_ANIM);
         }
   ...
   private PlayState actionPredicate(AnimationState<AttackTitanEntity> state) {
      state.getController().transitionLength(this.crouchTransitionTicksRemaining > 0 ? 4 : 7);
      if (this.isDefeated()) {
         ...
         if (hitReaction > 0) {
         ...
         } else if (this.isVariantShifter() && this.dataTracker.get(DATA_FULLY_DISMOUNTED)) {
            return state.setAndContinue(DISMOUNT_CROUCH_ANIM);
         } else if (this.isDismounting()) {
            return this.isVariantShifter() && this.isInSneakingPose() ? state.setAndContinue(DISMOUNT_CROUCH_ANIM) : state.setAndContinue(DISMOUNT_ANIM);
            ...
            return this.isVariantShifter() && this.idleTicks >= 100 ? state.setAndContinue(IDLE_BORED_UPPER_ANIM) : state.setAndContinue(IDLE_UPPER_ANIM);
         }
      }
   }
