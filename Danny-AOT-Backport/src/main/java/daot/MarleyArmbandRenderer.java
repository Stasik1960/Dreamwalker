...
public class MarleyArmbandRenderer extends GeoArmorRenderer<MarleyArmbandItem> {
   public MarleyArmbandRenderer() {
      super(new MarleyArmbandModel());
   }

   public void updateModelState(LivingEntity entity, ItemStack stack) {
      MarleyArmbandModel model = (MarleyArmbandModel)this.getGeoModel();
      MarleyArmbandItem item = (MarleyArmbandItem)stack.getItem();
