...
public class RedScarfItem extends daot.compat.BackportArmorItem implements GeoItem {
   ...
   public RedScarfItem(ArmorMaterial material, Type type, Settings properties) {
