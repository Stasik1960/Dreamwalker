...
Последний запрос: исправить все формы/установку, двери и старые ошибки до публикации. Пользователь запрещает запуск Minecraft на своём ПК. Пользователь разрешил публикацию на GitHub и обновление основного README. Пользовательский мир не открыт и не менялся.
