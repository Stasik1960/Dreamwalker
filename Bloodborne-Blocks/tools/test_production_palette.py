...
class ProductionPaletteTests(unittest.TestCase):
    ...
    def test_exact_manifest_registry_and_no_superseded_members(self):
        ...
        self.assertEqual(33,len(ids));self.assertEqual(ids,set(self.blocks));self.assertEqual(ids,set(self.families))
    ...
    def test_tree_and_semantic_supersession(self):
        ...
        expected={'C008':4,'C1491':3,'C1962':2,'C1979':5,'C471':2,'C282':1,'C654':2}
        ...
        for index,direction in enumerate(facing):
            ...
            for polygon in source:
                ...
                for j,other in enumerate(remaining):
                    if polygon['texture']!=other['texture'] or len(a)!=len(other['vertices']):continue
